...
import com.onedayoffer.taskdistribution.services.TaskDistributorImpl;
...
public class DistributionTest {
    ...
    @Autowired
    @Qualifier("TaskDistributorImpl")
    private TaskDistributor taskDistributorImpl;
    @Autowired
    @Qualifier("TaskDistributorImplSecond")
    private TaskDistributor taskDistributorImplSecond;
    ...
    public void shouldDistribute() {
        ...
        taskDistributorImpl.distribute(employees, tasks);
    ...
    @Test
    public void shouldDistributeSecond() {
        List<EmployeeDto> employees = dataGenerator.getEmployees();
        List<TaskDto> tasks = dataGenerator.getTasks();
        taskDistributorImplSecond.distribute(employees, tasks);
